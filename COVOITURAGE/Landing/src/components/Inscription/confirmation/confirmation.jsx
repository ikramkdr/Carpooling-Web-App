                ...
                {!isCodeSent ? (
                    ...
                    <>
                        ...
                        <form onSubmit={updatePassword}>
                            <label htmlFor="newPassword"><h4>mot de passe</h4></label>
                            <input
                                className='inputdistance'
                            ...
                            <br /><br />
                            <input className='inputdistance' type="submit" id='boutonconnexion' value='Finir' />
                        </form>
                    </>
                ) : (
                    <p>Votre Compte est maintenant active!</p>
                )}
            </div>
        </section>
    );
