...
import heart from '../../../assets/nonelike.svg';
import Fromto from '../../../assets/fromto.svg';
import Hear from '../../../assets/Vector.svg'

import './MesTrajets.css'; // Import the CSS for styling
...
function MesTrajets() {
    ...
    return (
        <div className="mes-trajets">
            <div className='sideB'>{Sidebar(1)}</div>
            <div className='content'>
                <div id='headerrTrajet'>
                    <h2 id='Titre'>Mes trajets</h2>
                    <NavigationBar />
                </div>
                <hr />
            ...
            <img src={liked ? Hear : heart} alt="liker" />
        </button>
                            </div>
                        </div>
